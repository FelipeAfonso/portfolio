...
export const professional: Record<string, Experience> = {
  venture_lab_niterra: {
    ...
    endDate: "isCurrent",
    description: [
      `Built Niterra Ventures, the internal system of record for the venture arm's entire investment lifecycle — portfolio companies and their quarterly financials, editable cap tables, scenario-based exit models, a deal funnel, expense and contract tracking, board-deck generation, and P&L / balance-sheet reporting.`,
      `Consolidated an Affinity CRM workflow and eight sprawling spreadsheets into a single platform (8 → 1), now the daily system of record for 40+ people across the firm — 10+ of them in it 2+ hours a day.`,
      `Cut the senior principal's quarterly portfolio deck from ~120 hours of manual work to a seconds-long export he finishes by hand in about a day.`,
      `Wired live integrations (Affinity CRM, PitchBook, Webflow) and mapped Excel imports so quarterly company reports map straight in — saving ~1 hour per company per quarter with no re-keying.`,
      `Iterated continuously on the platform's internal tooling to reduce operational friction across the team's day-to-day workflows.`,
    ],
    workedWith: [
      "SvelteKit",
      "Svelte 5",
